...
<head>
    ...
    <title>Trang liên hệ | Cooking Tutorial</title>
        ...
        <section class="mb-3">
            <div class="container py-5">
                <div class="row">
                    <!-- Contact Form -->
                    <div class="col-md-6">
                        <h2 class="text-warning">Liên hệ với chúng tôi</h2>
                        <form action="mail_process.php" enctype="multipart/form-data" method="POST">
                            ...
                            <button type="submit" class="btn btn-warning">Gửi ý kiến, phản hồi</button>
                        </form>
                    </div>

                    <!-- Map -->
                    <div class="col-md-6">
                        <h2 class="text-warning">Địa chỉ</h2>
                        <iframe
