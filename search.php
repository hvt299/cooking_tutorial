<?php
    ...
    if (isset($_POST['submit'])){
        $str = $_POST['string'];
        $course1 = get_course_by_name($str);        
    }
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <section class="mb-3">
            <div class="container py-5">
                ...
                <div class="row row-cols-1 row-cols-md-3 g-4 py-5">
                    <?php foreach ($course1 as $s): ?>
                        <form action="course_info.php" method="GET">
                            <input type="hidden" name="course_id" value="<?php echo $s['IDKH']; ?>">
                            <div class="col h-100">
                                <div class="card h-100">
                                    <img src="<?php echo $s['HinhAnhKH']; ?>" class="card-img-top" alt="">
                                    <div class="card-body">
                                        <a href="course_info.php?course_id=<?php echo $s['IDKH']; ?>"><h5 class="card-title"><?php echo $s['TenKH']; ?></h5></a>
                                        <!-- <p class="card-text">
                                            <?php
                                    ...
                                    <div class="d-flex justify-content-around mb-4">
                                        <h4 class="price"><?php echo number_format($s['GiaHienTaiKH'],0,",",".")."<ins>đ</ins>"; ?></h4>
                                        <del><?php echo number_format($s['GiaGocKH'],0,",",".")."<ins>đ</ins>"; ?></del>
